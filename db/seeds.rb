...
10.times do
  Event.create(start_date: Faker::Date.forward(days:60), duration: 15, title: Faker::Science.scientist, description: Faker::Lorem.sentence, price: rand(1..1000), location: Faker::Address.city)
end
